...
End-to-end worked example: a financial-services partner submits two consecutive 10-K filing excerpts (this year vs. last year), the agent identifies material changes and risk flags, and returns a structured analyst-ready summary. Because filings are long and the analysis takes minutes, this uses Libra OS's async-job pattern — submit, poll, retrieve.
